...
controllers.controller('LanguagesCtrl', ['$scope', function($scope){
  $scope.languages = [];
...
controllers.controller('SkillsCtrl', ['$scope', function($scope){
  $scope.skills = [];
...
controllers.controller('ResumeCtrl', ['$scope', function($scope){
  ...
  $scope.stories.push({chapter: "Post-launch, codes a better version of the app. Discovers his love for programming and building great products. Leaves startup to pursue his newfound passion.",
                      prevTitle: "Actual Entrepreneur",
                      nextTitle: "Programming Noob"});
  $scope.stories.push({chapter: "Learns Objective-C, Ruby (rails), Java in under 5 months. He's obsessed with learning and building cool things. Launches a mac app.", 
                      prevTitle: "Programming Noob",
                      nextTitle: "Code Addict"});
  $scope.stories.push({chapter: "Accelerates his learning: Writes DRY, clean, and concise code. Masters VIM. Implements TDD/BDD & Agile. Collaborates with others. Wins in a hackathon.", 
